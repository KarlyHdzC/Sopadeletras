...
public class Arbitro {
	...
	private List<String> palabras=new ArrayList<String>();
        private List<String> palabras2=new ArrayList<String>();
        private List<String> palabras3=new ArrayList<String>();
	/**
	...
	public String palabrastoString(){
        ...
        public String palabras2toString(){
		String s=new String();
		
		palabras3.add(palabras2.remove(palabras.size()-1));
                for (String str:palabras3){
			s+=str;
			s+="  ";
		}
		return s;
	}
        public String palabrastoLength(){
		String s=new String();
		for (String str:palabras){
			s+=str.length();
			s+="  ";
